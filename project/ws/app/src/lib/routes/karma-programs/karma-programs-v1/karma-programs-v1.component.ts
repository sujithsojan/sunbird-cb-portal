...
@Component({
  selector: 'ws-app-karma-programs-v1',
  templateUrl: './karma-programs-v1.component.html',
  styleUrls: ['./karma-programs-v1.component.scss']
})
export class KarmaProgramsV1Component implements OnInit {
